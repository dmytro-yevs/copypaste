...
private val ClassicSkinTokens = SkinTokens(
    ...
    saturation         = 1.45f,   // Android ColorMatrix scale; Classic uses 1.45 (web CSS saturate(145%) maps here).
    // Classic fillAlpha = 0.62 per design contract (SkinTokensTest §2, frozen § rule 1).
    // This drives the glass surface overlay alpha for Classic; GlassTier's own
    // lightAlphaTop/Bottom gradient (0.64→0.46 GLASS / 0.58→0.40 CARD) is separate.
    fillAlpha          = 0.62f,
    sheen              = 0.06f,
