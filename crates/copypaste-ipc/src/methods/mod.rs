...
pub use clipboard::{
    StatsResponse, METHOD_ADD_FILE_ITEM, METHOD_COPY, METHOD_COPY_ITEM, METHOD_COUNT,
    METHOD_DELETE, METHOD_DELETE_ALL, METHOD_DELETE_ITEM, METHOD_EXPORT, METHOD_GET_APP_ICON,
...
pub use pairing::{
    ...
    METHOD_PAIR_WITH_DISCOVERED, METHOD_POLL_PEER_EVENTS, METHOD_REORDER_PINNED,
    METHOD_RESCAN_DISCOVERED, METHOD_REVOKE_ALL_PEERS, METHOD_REVOKE_PEER, METHOD_UNPAIR_PEER,
};
