...
pub use methods::{
    ResetDatabaseRequest, ResetDatabaseResponse, VacuumRequest, VacuumResponse,
    METHOD_CLOUD_TEST_CONNECTION, METHOD_COPY, METHOD_COUNT, METHOD_DELETE, METHOD_DELETE_ALL,
    METHOD_EXPORT, METHOD_GET_CONFIG, METHOD_GET_PRIVATE_MODE, METHOD_GET_SYNC_STATUS,
    METHOD_IMPORT, METHOD_LIST, METHOD_PAIR_GENERATE_QR, METHOD_PIN_ITEM, METHOD_RESET_DATABASE,
    METHOD_SEARCH, METHOD_SET_CONFIG, METHOD_SET_PRIVATE_MODE, METHOD_STATS, METHOD_STATUS,
    METHOD_VACUUM,
};
