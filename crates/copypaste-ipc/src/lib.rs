...
pub use methods::{
    ResetDatabaseRequest, ResetDatabaseResponse, StoreCloudPasswordRequest,
    StoreCloudPasswordResponse, VacuumRequest, VacuumResponse, METHOD_CLOUD_TEST_CONNECTION,
    METHOD_COPY, METHOD_COUNT, METHOD_DELETE, METHOD_DELETE_ALL, METHOD_EXPORT, METHOD_GET_CONFIG,
    ...
    METHOD_STORE_CLOUD_PASSWORD, METHOD_VACUUM,
};
