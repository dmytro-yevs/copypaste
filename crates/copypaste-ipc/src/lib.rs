...
pub use methods::{
    ...
    METHOD_DB_RESTORE, METHOD_DB_STATS, METHOD_DELETE, METHOD_DELETE_ALL, METHOD_DELETE_ITEM,
    ...
    METHOD_UNPAIR_PEER, METHOD_VACUUM, METHOD_WATCH_SUBSCRIBE, SYNC_BADGE_RECENT_MS,
};
