...
pub use methods::{
    compute_sync_badge_state, DbStatsResponse, GetSyncStatusResponse, ResetDatabaseRequest,
    ...
    METHOD_COUNT, METHOD_DB_STATS, METHOD_DELETE, METHOD_DELETE_ALL, METHOD_DELETE_ITEM,
    METHOD_EXPORT, METHOD_GET_APP_ICON, METHOD_GET_CONFIG, METHOD_GET_ITEM_FILE,
    METHOD_GET_ITEM_IMAGE, METHOD_GET_ITEM_THUMBNAIL, METHOD_GET_OWN_DEVICE_INFO,
    METHOD_GET_OWN_FINGERPRINT, METHOD_GET_PRIVATE_MODE, METHOD_GET_SYNC_STATUS,
    METHOD_HISTORY_PAGE, METHOD_IMPORT, METHOD_LIST, METHOD_LIST_DISCOVERED, METHOD_LIST_PEERS,
    METHOD_PAIR_ABORT, METHOD_PAIR_CONFIRM_SAS, METHOD_PAIR_GENERATE_QR, METHOD_PAIR_GET_SAS,
    METHOD_PAIR_PEER_WITH_PASSWORD, METHOD_PAIR_WITH_DISCOVERED, METHOD_PIN_ITEM,
    METHOD_POLL_PEER_EVENTS, METHOD_REORDER_PINNED, METHOD_RESCAN_DISCOVERED,
    METHOD_RESET_DATABASE, METHOD_REVOKE_ALL_PEERS, METHOD_REVOKE_AND_ROTATE, METHOD_REVOKE_PEER,
    METHOD_ROTATE_SYNC_KEY, METHOD_SEARCH, METHOD_SET_CONFIG, METHOD_SET_PRIVATE_MODE,
    METHOD_SET_SYNC_PASSPHRASE, METHOD_STATS, METHOD_STATUS, METHOD_STORE_CLOUD_PASSWORD,
    METHOD_UNPAIR_PEER, METHOD_VACUUM, SYNC_BADGE_RECENT_MS,
};
