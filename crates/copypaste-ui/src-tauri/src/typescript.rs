...
mod tests {
    ...
    fn capture_bindings_match_the_runtime_serialization_contract() {
        ...
        assert!(generated.contains("export interface UiCommandArgs {"));
        assert!(generated.contains("  list: { limit: number; cursor: string | null };"));
        assert!(generated.contains(
            "  install_update: { expectedVersion: string; progress: Channel<UpdateProgress> };"
        ));
        assert!(generated.contains("export interface UiCommandResult {"));
        assert!(generated.contains("  status: StatusData;"));
        assert!(generated.contains("  diagnostics: Diagnostics;"));
