...
export const PALETTES: Record<PaletteKey, PaletteDef> = {
  "liquid-blue": {
    ...
    accent: "#4d8dff", accent2: "#7fc7ff", accent3: "#9e7bff", onAccent: "#080C16",
    success: "#67df81", warning: "#ffbd45", danger: "#ff6b78",
    glassOpacity: 0.40, glassBlur: "28px", glassSaturation: 1.45, glowStrength: 0.62,
  ...
  "graphite-mist": {
    ...
    accent: "#9db7df", accent2: "#d5e2f7", accent3: "#7c8ca6", onAccent: "#080C16",
  ...
  "deep-sky": {
    ...
    accent: "#1f9cff", accent2: "#8cddff", accent3: "#4d74ff", onAccent: "#080C16",
  ...
  "nordic-cyan": {
    ...
    accent: "#25d5b4", accent2: "#8af5e4", accent3: "#5a9dff", onAccent: "#080C16",
  ...
  "cloud-silver": {
    ...
    accent: "#5b8def", accent2: "#2f74e8", accent3: "#9cb3d7", onAccent: "#080C16",
  ...
  "frost-blue": {
    ...
    accent: "#2777ff", accent2: "#005fe3", accent3: "#72b8ff", onAccent: "#080C16",
  ...
  "porcelain": {
    ...
    accent: "#3c7dd9", accent2: "#1e5fb9", accent3: "#8fb8e8", onAccent: "#080C16",
  ...
  "aurora-violet": {
    ...
    accent: "#9a7cff", accent2: "#d4b6ff", accent3: "#ff7ad9", onAccent: "#080C16",
  ...
  "amber-night": {
    ...
    accent: "#ffad33", accent2: "#ffd28a", accent3: "#6ca0ff", onAccent: "#080C16",
