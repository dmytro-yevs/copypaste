export const devices = {
  ...
  presentation: {
    ...
    status: {
      ...
      presenceUnknownDetail: "Current network presence is unavailable.",
      synced: "Synced",
      away: "Away",
      awayDetail: "Not seen on this network. Sync remains available.",
      waiting: "Waiting",
      waitingDetail: "This pairing has not completed a successful sync yet.",
      inboundDetail: "This device has no last known address for an outgoing sync.",
      needsAttention: "Needs attention",
      needsAttentionDetail: "This device has not synced successfully for a while.",
    ...
    connection: {
      multipleTitle: "{{count}} devices need attention",
      multipleDetail: "Review the devices with unresolved sync failures.",
      reviewDevices: "Review devices",
      syncingTitle: "Syncing your devices",
      syncingDetail: "{{count}} devices{{suffix}}",
      lastSynced: "last synced {{age}}",
      syncFailedTitle: "Sync with {{name}} failed",
      syncFailedDetail: "The device was reached, but the last sync session did not finish.",
      tryAgain: "Try again",
      pairingNeedsAttentionTitle: "{{name}}'s pairing needs attention",
      pairingNeedsAttentionDetail: "CopyPaste could not verify the saved trust for this device.",
      updateNeededTitle: "{{name}} needs an update",
      updateNeededDetail: "Update CopyPaste on both devices before syncing again.",
      noLongerPairedTitle: "{{name}} is no longer paired",
      noLongerPairedDetail: "Review this device and remove the stale pairing.",
      pairingKeyTitle: "{{name}}'s pairing key cannot be used",
      pairingKeyDetail: "Review this device before trying to sync again.",
      reviewDevice: "Review device",
      justNow: "just now",
    ...
    cloud: {
      ...
      manage: "Manage",
      unavailable: "Cloud status is unavailable.",
      notConfigured: "Not configured · direct device sync still works",
      signedOut: "Sign in from Settings to use encrypted cloud",
      attention: "Encrypted cloud needs attention",
      healthy: "End-to-end encrypted · healthy",
    },
    discovery: {
      unavailable: "Unavailable",
      identity: "Identity",
      ...
      sourceValue: "mDNS network advertisement",
      authentication: "Authentication",
      authenticated: "Authenticated pairing",
      notAuthenticated: "Not authenticated",
      reportedTrust: "Reported detail trust",
    ...
    discoveryCard: {
      ...
      ariaLabel: "{{name}}. Network-advertised name, unverified. {{status}}. Show details.",
    },
    detail: {
