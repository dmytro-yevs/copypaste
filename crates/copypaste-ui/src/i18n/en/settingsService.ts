export const settingsService = {
  ...
  exclusions: {
    ...
    searchInstalled: "Search installed applications",
    installedList: "Installed applications",
    refreshApps: "Refresh installed applications",
    retryApps: "Try again",
    loadingApps: "Reading installed applications…",
    appsUnavailable: "Installed applications couldn't be read.",
    appsUnavailableBody: "You can retry or add an application by its identifier below.",
    noInstalledMatches: "No installed applications match this search.",
    manualTitle: "Add by identifier",
    manualDescription: "Use this when an application isn't listed or is no longer installed.",
    add: "Add app",
    remove: "Remove {{id}}",
    ...
    windowsDescription: "Choose a registered application or enter the process name shown in Task Manager.",
  ...
  sound: {
    title: "Copy feedback sound",
    description: "Plays after CopyPaste saves or copies an item.",
  },
  lan: {
