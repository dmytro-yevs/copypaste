...
export function SourceMetaBadge({ icon, tone = "accent", label, title }: {
  icon: IconName;
  tone?: "accent" | "warning";
  label: ReactNode;
  title?: string;
