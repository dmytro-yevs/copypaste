...
function PairingField({
  ...
  return (
    <button
      ...
      className="group flex min-w-0 items-center gap-s-2 rounded-md border border-input bg-muted px-s-2 py-s-2 text-left transition-colors hover:bg-accent focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:outline-none"
    >
