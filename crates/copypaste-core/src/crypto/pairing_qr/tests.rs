...
fn sample_with_provisioning() -> PairingPayload {
    PairingPayload {
        fingerprint: "aabbccddeeff00112233445566778899aabbccddeeff00112233445566778899".to_string(),
...
fn empty_addr_hint_roundtrips() {
    ...
    let payload = PairingPayload {
        fingerprint: "deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef".to_string(),
...
fn device_name_with_special_chars_roundtrips() {
    // Use valid 32-byte fingerprint and UUID so CPPAIR2 encode/decode succeeds.
    let payload = PairingPayload {
        fingerprint: "cafecafecafecafecafecafecafecafecafecafecafecafecafecafecafecafe".to_string(),
