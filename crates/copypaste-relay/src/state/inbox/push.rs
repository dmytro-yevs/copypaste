//! Push (wall-clock sync protocol): `push_item` (test helper) and the
//! production `push_item_decoded` hot path.

use std::sync::atomic::Ordering;

use crate::error::RelayError;

use super::super::quota::effective_history_cap;
use super::types::SyncItem;
...
impl super::super::RelayStore {
    ...
    pub fn push_item_decoded(
        ...
        *counter = next_counter;
        ...
        use super::super::persistence::PendingDbWrite;
